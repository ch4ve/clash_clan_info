...
async def _get_scouting_report_async(our_clan_tag, coc_email, coc_password):
    ...
    try:
        ...
        _, their_clan_df, their_opponent_df, their_clan_tag, _ = await _get_cwl_current_war_details_async(next_opponent_tag, coc_email, coc_password, existing_client=client)
