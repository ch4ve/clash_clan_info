...
# As funções _get_cwl_data_async e _get_cwl_schedule_async podem ser adicionadas aqui se necessário,
# seguindo o mesmo padrão de receber o cliente e o login.
