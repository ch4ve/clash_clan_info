...
# Esta é a abordagem mais simples e vamos mantê-la.
...
async def _generate_full_league_preview_async(our_clan_tag, coc_email, coc_password):
    ...
    try:
        ...
        # Helper interno para não precisar recriar o cliente toda vez
        async def _internal_get_war_details(tag):
            return await _get_cwl_current_war_details_async(tag, coc_email, coc_password, existing_client=client)
...
# Helper interno para a função acima, para aceitar um cliente já existente
